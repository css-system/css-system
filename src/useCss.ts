import {CSSObject, SystemStyleObject, Theme} from "@styled-system/css"
...
const camelCaseToSnakeCase = (prop : string) : string => prop.replace(/[A-Z]/g, match => `-${
    match.toLowerCase()
}`)

const populateRulesObject = (className : string, cssObject : CSSObject, acc : any) => {
...
export const useCss = (systemObject : SystemStyleObject, theme : Theme, deps? : any[]) : string => {
